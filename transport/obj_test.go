...
func Example_headers() {
	...
	// Output:
	// {Bck:aws://@uuid#namespace/abc ObjName:X ObjAttrs:{Atime:663346294 Size:231 Ver:1 ETag: Cksum:(xxhash,h1...) customMD:map[]} Opaque:[] SID: Opcode:0} (69)
	// {Bck:ais://abracadabra ObjName:p/q/s ObjAttrs:{Atime:663346294 Size:213 Ver:222222222222222222222222 ETag: Cksum:(xxhash,h2...) customMD:map[xx:11 yy:22]} Opaque:[49 50 51] SID: Opcode:0} (110)
}
