...
| Intra-cluster protection        | `AIS_AUTH_INTRA_CLUSTER_REQUEST_AUTH`, `AIS_AUTH_INTRA_CLUSTER_TTL`, `AIS_AUTH_INTRA_CLUSTER_NONCE_WINDOW`, `AIS_AUTH_INTRA_CLUSTER_ROTATION_GRACE`                                                                                             | Configure protection for selected intra-cluster requests. This is independent from `AIS_AUTHN_ENABLED`.                   |
...
| Space                           | `AIS_SPACE_LOWWM`, `AIS_SPACE_HIGHWM`, `AIS_SPACE_OOS`                                                                                                                                                                                          | Override selected local thresholds.                                                                                       |
