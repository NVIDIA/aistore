...
| Set [bucket properties](bucket.md#properties-and-options) (proxy) | PUT {"action": "setprops"} /v1/buckets/bucket-name | `curl -i -X PUT -H 'Content-Type: application/json' -d '{"action":"setprops", "value": {"next_tier_url": "http://G-other", "cloud_provider": "ais", "read_policy": "cloud", "write_policy": "next_tier", "cksum": { "checksum": "inherit" }}}' 'http://G/v1/buckets/abc'` |
