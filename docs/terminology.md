...
AIS [supports multiple storage backends](https://github.com/NVIDIA/aistore/blob/main/docs/providers.md) including its own (`ais://@uuid` or `ais://@alias` for remote clusters).
