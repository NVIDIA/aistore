...
Content resolution — the internal mechanism for mapping object names to [mountpaths](https://github.com/NVIDIA/aistore/blob/main/docs/terminology.md#mountpath) — was revamped to minimize string allocations and speed up lookups across mountpaths.
