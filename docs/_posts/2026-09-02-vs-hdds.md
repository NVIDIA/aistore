...
And if a deployment does need a tenth of that nominal figure, size for it directly: thirty HDD servers deliver 740 Gb/s along with 17 PB of raw capacity and $276K of media.
The all-NVMe answer to the same requirement is $7.7M.
...
> The HDD figure is a purchase spread across an assumed five-year interval: one-time $2.9K–$3.2K/(GB/s) comes down to the five-year annualized $0.6K/(GB/s).
