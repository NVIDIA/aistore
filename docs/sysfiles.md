...
| ---- | ---- | ---- | ----------------- | ----------- |
| `.ais.bmd` | file | gateway | Buckets Metadata | Names and properties of all buckets, including cached and replicated [Cloud buckets](./providers.md) and [remote AIStore](./providers.md) buckets |
