...
declare -A title_overrides=(
  ...
  ["terminology"]="Terminology and Core Abstractions"
...
declare -A descriptions=(
  ...
  ["terminology"]="Definitions of AIStore core terms and abstractions: buckets, targets, proxies, mountpaths, xactions, shards, and more."
