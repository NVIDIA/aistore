...
func TestDecodeS3XML(t *testing.T) {
	...
	ecode, err := s3.DecodeBodyXML(req, &decoded, maxDeleteXMLSize, "multi-object delete body")
...
func TestDecodeS3XMLRejectsDeclaredOversize(t *testing.T) {
	...
	ecode, err := s3.DecodeBodyXML(req, &s3.VersioningConfiguration{}, maxVersioningXMLSize, "bucket versioning body")
