...
// Legacy CSK/HMAC support.
//
// Deprecated: CSK is the pre-v5.0 HMAC-based implementation for authenticating
// selected intra-cluster requests. New configuration and call sites should use
// the generic intra-cluster sign/verify terminology (`auth.intra_cluster`).
// TODO: remove after per-node Ed25519 signing fully replaces CSK/HMAC.
//
...
// Configuration:
//   Controlled via cluster config: auth.intra_cluster.enabled
//   See cmn.IntraClusterConf for time windows and related settings.
// HMAC:
