CLI allows a user to attach any remove AIS cluster and works transparently with its buckets and objects. See more about remote clusters and examples [here](/docs/providers.md).
