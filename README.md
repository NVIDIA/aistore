...
only by other components of DFC (e.g. multi-tiering). Object transfer is on both send and receive side protected by checksums, ensuring every byte is correctly transferred from
