# openapi-client
AIStore is a scalable object-storage based caching system with Amazon and Google Cloud backends.
...
*DaemonApi* | [**perform_operation**](docs/DaemonApi.md#perform_operation) | **PUT** /daemon/ | Perform operations such as setting config value, shutting down proxy/target etc. on a AIStore daemon
