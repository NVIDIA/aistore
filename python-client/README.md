# openapi-client
AIS is a scalable object-storage based caching system with Amazon and Google Cloud backends.
...
For more information, please visit [https://github.com/NVIDIA/aistore](https://github.com/NVIDIA/aistore)
...
*DaemonApi* | [**perform_operation**](docs/DaemonApi.md#perform_operation) | **PUT** /daemon/ | Perform operations such as setting config value, shutting down proxy/target etc. on a AIS daemon
