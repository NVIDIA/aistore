...
class DaemonApi(object):
    ...
    def perform_operation_0(self, file_system_request, **kwargs):  # noqa: E501
        """Enable a filesystem on a DFC target  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.perform_operation_0(file_system_request, async=True)
        >>> result = thread.get()

        :param async bool
        :param FileSystemRequest file_system_request: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.perform_operation_0_with_http_info(file_system_request, **kwargs)  # noqa: E501
        else:
            (data) = self.perform_operation_0_with_http_info(file_system_request, **kwargs)  # noqa: E501
            return data

    def perform_operation_0_with_http_info(self, file_system_request, **kwargs):  # noqa: E501
        """Enable a filesystem on a DFC target  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.perform_operation_0_with_http_info(file_system_request, async=True)
        >>> result = thread.get()
        ...
        all_params = ['file_system_request']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method perform_operation_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'file_system_request' is set
        if ('file_system_request' not in params or
                params['file_system_request'] is None):
            raise ValueError("Missing the required parameter `file_system_request` when calling `perform_operation_0`")  # noqa: E501
        ...
        body_params = None
        if 'file_system_request' in params:
            body_params = params['file_system_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain'])  # noqa: E501
