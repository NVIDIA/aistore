OPENAPI_MISSING_ERR = 'ais_client missing, you probably forgot to generate the package (refer to https://github.com/NVIDIA/aistore/blob/master/openapi/README.md#how-to-generate-package)'
