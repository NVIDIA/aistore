...
from aistore.client.const import QParamWhat, HTTP_METHOD_GET, HTTP_METHOD_PUT
from aistore.client.errors import Timeout
from aistore.client.types import XactStatus
...
class TestXaction(unittest.TestCase):
    ...
    @patch("aistore.client.xaction.time.sleep")
    @patch("aistore.client.xaction.Xaction.xact_status")
