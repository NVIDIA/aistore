...
type (
	ContentResolver interface {
		...
		GenUniqueFQN(base string, extras ...string) (ufqn string)
...
var (
	...
	_ ContentResolver = (*ObjCMContentResolver)(nil)
)
...
func (f *contentSpecMgr) Gen(parts PartsFQN, contentType string, extras ...string) (fqn string) {
	...
	objName := spec.GenUniqueFQN(parts.ObjectName(), extras...)
...
func (*ObjectContentResolver) GenUniqueFQN(base string, _ ...string) string { return base }

func (*ObjectContentResolver) ParseUniqueFQN(base string) (orig string, old, ok bool) {
	return base, false, true
}

func (*WorkfileContentResolver) GenUniqueFQN(base string, extras ...string) string {
...
func (*ObjChunkContentResolver) GenUniqueFQN(base string, extras ...string) string {
	debug.Assert(len(extras) == 2, "expecting uploadID and chunk number, got: ", extras)
	return base + ssepa + extras[0] + ssepa + extras[1]
}

func (*ObjChunkContentResolver) ParseUniqueFQN(base string) (string, bool, bool) {
	// (chunk number)
...
func (*ObjCMContentResolver) GenUniqueFQN(base string, extras ...string) string {
	debug.Assert(len(extras) == 1, "expecting uploadID, got: ", extras)
	return base + ssepa + extras[0]
}

func (*ObjCMContentResolver) ParseUniqueFQN(base string) (orig string, old, ok bool) {
	i := strings.LastIndexByte(base, bsepa)
	if i < 0 {
		return base, false, false
	}
...
func (*ECSliceContentResolver) GenUniqueFQN(base string, _ ...string) string { return base }

func (*ECSliceContentResolver) ParseUniqueFQN(base string) (orig string, old, ok bool) {
	return base, false, true
}

func (*ECMetaContentResolver) GenUniqueFQN(base string, _ ...string) string { return base }
