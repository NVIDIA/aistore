...
func TestParseFQN(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			[]string{"/tmp"},
			"/tmp", cmn.Bck{Name: "bucket", Provider: cmn.ProviderAmazon, Ns: cmn.NsGlobal}, fs.WorkfileType, "objname", false,
		},
		{
			"cloud as bucket type (aws)",
			"/tmp/@aws/bucket/%ob/objname",
			[]string{"/tmp"},
			"/tmp", cmn.Bck{Name: "bucket", Provider: cmn.ProviderAmazon, Ns: cmn.NsGlobal}, fs.ObjectType, "objname", false,
		},
		{
		...
		},
		{
			...
			"/tmp/super/long", cmn.Bck{Name: "bucket", Provider: cmn.ProviderAmazon, Ns: cmn.NsGlobal}, fs.ObjectType, "objname", false,
		},
		{
			"long mount path name and objname in folder",
			"/tmp/super/long/@aws/bucket/%ob/folder/objname",
			[]string{"/tmp/super/long"},
			"/tmp/super/long", cmn.Bck{Name: "bucket", Provider: cmn.ProviderAmazon, Ns: cmn.NsGlobal}, fs.ObjectType, "folder/objname", false,
		},
		{
			...
			"/tmp/super/long/long", cmn.Bck{Name: "bucket", Provider: cmn.ProviderAmazon, Ns: cmn.NsGlobal}, fs.ObjectType, "folder/objname", false,
		},
		{
			"dirty mpath",
			"/tmp/super/long/long/@gcp/bucket/%ob/folder/objname",
			[]string{"/tmp/super/long", "/tmp/.////super/../super//./long///////////long"},
			"/tmp/super/long/long", cmn.Bck{Name: "bucket", Provider: cmn.ProviderGoogle, Ns: cmn.NsGlobal}, fs.ObjectType, "folder/objname", false,
		},
