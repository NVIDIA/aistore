...
SK accepts a number of command-line arguments, all of which can also be passed by passing the arguments into `soaktest.sh`:
 ...
 - `-rec-minsize` - Min filesize in recipes (default 300MiB), can specify with [multiplicative suffix](/docs/aisloader.md#bytes-multiplicative-suffix).
 - `-rec-maxsize` - Max filesize in recipes (default 1GiB), can specify with [multiplicative suffix](/docs/aisloader.md#bytes-multiplicative-suffix).
 ...
 - `-reg-minsize` - Min filesize in regression (default 700MiB), can specify with [multiplicative suffix](/docs/aisloader.md#bytes-multiplicative-suffix).
 - `-reg-maxsize` - Max filesize in regression (default 2GiB), can specify with [multiplicative suffix](/docs/aisloader.md#bytes-multiplicative-suffix).
