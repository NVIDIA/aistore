...
if [ "$etl" = true ]; then
  ...
  aisloader -bucket="$bucket_name" -duration="$duration" -pctput=10 -provider=ais  -maxsize=10Mib -minsize=1Mib -totalputsize=5Gib -cleanup=true -numworkers=8 -etl=tar2tf
else
