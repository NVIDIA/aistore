...
parser.add_argument('--elimit', type=int, default=0, help='limits number of concurrent shards extracted')
parser.add_argument('--climit', type=int, default=0, help='limits number of concurrent shards created')
